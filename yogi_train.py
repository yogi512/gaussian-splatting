...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    ############################################################################
    # Calculate distances between training and test cameras
    train_cameras = scene.getTrainCameras().copy()
    try:
        test_cameras = scene.getTestCameras().copy()
        distances = calculate_distances(train_cameras, test_cameras)

    # Convert distances to sampling probabilities (inversely proportional to distance)
        ...
        probabilities = [1/len(train_cameras) for _ in train_cameras]
    ############################################################################
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        # print("Training iteration: ", iteration, "Camera: ", viewpoint_cam.image_name)
        # print("Camera position: ", viewpoint_cam.position)
        # print("Camera lookat: ", viewpoint_cam.lookat)
        # print("Camera up: ", viewpoint_cam.up)
        # print("Camera fov: ", viewpoint_cam.fov)
        # print("Camera image size: ", viewpoint_cam.image_size)
        # print("Camera image name: ", viewpoint_cam.image_name)
